...
export function addSummary(taskSummaryTableRows, actionName) {
    try {
        core.summary
...
export function processAndAddBuildSummary(runnerTemp, runId, actionName) {
    ...
    const filePath = join(runnerTemp, `buildSummary${runId}.json`);
