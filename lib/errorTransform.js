 ...
 */
export function transformError(output, command) {
...
function transformSyntaxError(output, command, prefixLength) {
...
function transformRuntimeError(output, command, prefixLength) {
...
//# sourceMappingURL=errorTransform.js.map