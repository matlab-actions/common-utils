...
export function processAndAddTestSummary(runnerTemp, runId, workspace) {
...
export function getTestResults(runnerTemp, workspace) {
...
export function addSummary(testResultsData, coverageResultsData) {
    try {
